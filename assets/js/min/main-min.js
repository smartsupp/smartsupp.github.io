...
// RESPONSIVE IMAGES
if(document.body.classList.contains("docs"))for(var headings=document.querySelectorAll("h1,h2,h3,h4"),i=0;i<headings.length;i++){var el=headings[i];el.insertAdjacentHTML("beforeend",'<a href="#'+el.id+'">#</a>')}window.onscroll=function(){scrollFunction()},document.addEventListener("DOMContentLoaded",function(){var t=document.querySelectorAll(".docs img"),e=Array.prototype.filter;0<t.length&&e.call(t,function(e){e.onload=function(){var t=e.offsetWidth;e.setAttribute("style","width: 100%; max-width: "+t+"px;")}})});